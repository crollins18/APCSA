...
public class NumberSearchDriver_CalebRollins
{
	public static void main( String args[] ) throws IOException
	{
		...
		for(int i = 0; i<size; i++) // Loop through each data set in the file
		{
			...
			NumberSearch_CalebRollins ns = new NumberSearch_CalebRollins(listOfNumbers);  // Construct a new NumberSearch object
