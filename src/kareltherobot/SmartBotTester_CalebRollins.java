...
public class SmartBotTester_CalebRollins implements Directions
{
	public static void main(String args[])  
	{
		...
		SmartBot_CalebRollins einstein = new SmartBot_CalebRollins(2, 2, North, 0);
		...
		einstein = new SmartBot_CalebRollins(2, 4, North, 0);
		if (!einstein.beeperIsToLeft())
		{
			einstein.turnOff();
		}
		...
		einstein = new SmartBot_CalebRollins(3, 4, North, 0);
		...
		einstein = new SmartBot_CalebRollins(3, 6, North, 0);
		if (einstein.beeperIsToRight())
		{
			einstein.turnOff();
		}
		...
		einstein = new SmartBot_CalebRollins(2, 7, North, 0);
		...
		einstein = new SmartBot_CalebRollins(2, 8, North, 0);
		if (!einstein.twoBeepersOrMoreOnCorner())
		{
			einstein.turnOff();
		}
		...
		einstein = new SmartBot_CalebRollins(2, 9, North, 0);
		if (!einstein.twoBeepersOrMoreOnCorner())
		{
			einstein.turnOff();
		}
		...
		einstein = new SmartBot_CalebRollins(6, 2, East, 0);
		einstein.faceNorth();
		...
		einstein = new SmartBot_CalebRollins(6, 4, North, 0);
		einstein.faceWest();
		...
		einstein = new SmartBot_CalebRollins(6, 6, North, 0);
		einstein.faceSouth();
		...
		einstein = new SmartBot_CalebRollins(6, 8, North, 0);
		einstein.faceEast();
