...
public class MazeWalker_CalebRollins_2 extends BetterRobot_CalebRollins
{
	public MazeWalker_CalebRollins_2 (int st, int av, Direction dir, int beeps)
	{
